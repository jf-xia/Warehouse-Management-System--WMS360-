                        ...
                        <!--End Backend error handler-->
                                                ...
                                                <div class="datatable-pages d-flex align-items-center">
                                                    ...
                                                    <span class="pagination-links d-flex">
                                                        ...
                                                        <span class="paging-input d-flex align-items-center">
                                                            ...
                                                            <input type="hidden" name="route_name" value="shopify/shopify-master-product-list">
                            ...
                            <table class="ebay-table w-100 mytable" id="testTable">
                                ...
                                <tr>
                                        ...
                                        <div class="d-flex justify-content-start">
                                            <div class="btn-group">
                                                <form action="{{url('all-column-search')}}" method="post" id="reset-column-data">
                                                    @csrf
                                                    <input type="hidden" name="search_route" value="shopify/shopify-master-product-list">
                                    ...
                                    <th class="title" style="width: 10%; vertical-align:top;">
                                        <div class="d-flex justify-content-start">
                                            <div class="btn-group">
                                                <a type="button" class="dropdown-toggle filter-btn" data-toggle="dropdown">
                                                    <a type="button" class="dropdown-toggle filter-btn" data-toggle="dropdown">
...
{{--                                                    @endif--}}
                                                    <div class="align-items-center mr-2"><a class="btn-size edit-btn" style="cursor: pointer" href="{{url('shopify/catalogue/'.$product_list->id.'/edit')}}" target="_blank" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></a></div>
                                                    <div class="align-items-center mr-2"><a class="btn-size view-btn" style="cursor: pointer" href="{{url('shopify/show/'.$product_list->id).'/view'}}" target="_blank" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a></div>
    ...
    <script type="text/javascript">
        ...
        function catalogue_search(){
            ...
            $.ajax({
                type: "POST",
                url: "{{url('shopify/master-product-search')}}",
                data: {
                    "_token" : "{{csrf_token()}}",
                    "name": search_value,
