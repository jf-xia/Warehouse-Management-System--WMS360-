...
@section('title')
    eBay | Profile List | Duplicate Profile | WMS360
@endsection
                                ...
                                <div id="account_site_data">
                                    ...
                                    <div id="add_variant_product">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10 wow pulse">
                                                <textarea class="col-10" name="condition_description">{{$result->condition_description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="condition" class="col-md-2 col-form-label required">PayPal Account</label>
                                        <div class="col-md-10 wow pulse">
