                ...
                <div class="row m-t-20">
                    <div class="col-md-12">
                        <div class="card-box shadow">
                            ...
                            <form role="form" class="vendor-form mobile-responsive" action= {{URL::to('ebay-update-account/'.$result->id)}} method="post">
                                @csrf

                                <div class="form-group row">
                                    <label for="name" class="col-md-2 col-form-label required">Ebay User Name</label>
                                    <div class="col-md-10 wow pulse">
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="account_name" value="{{$result->account_name}}" maxlength="80" onkeyup="Count();" required autocomplete="name" autofocus>
                                    ...
                                    <div class="col-md-10 wow pulse">
                                        <select id="site_id" class="form-control select2 @error('site') is-invalid @enderror" multiple="multiple" name="site_id[]" value="{{ old('site_id') }}" required autocomplete="site_id" autofocus>
                                            @foreach($sites as $site)
                                                @foreach($result->sites as $account_sites)
