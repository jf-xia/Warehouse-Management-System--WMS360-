                    ...
                    <div class="right-content-1">
                        <div class="item-container">
                            ...
                            <div class="product-view-name-sku">
                                <!-- start product name -->
                                <h2 class="product-view-name">{{$product_result[0]->name}}</h2>
                                <!-- end product name -->
                            </div>
                        ...
                        <div class="panel panel-default img-gallery">
                            <div class="image-gallery">
                                <div class="slider clearfix">
                                    <!--Image Gallery Start-->
                                    <div class="img-details gallery-main-thum"><img src="{{$product_result[0]->images[0]->image_url}}" /></div>
                                    <div class="hallery-thum">
                                        @foreach($product_result[0]->images as $key => $image)
                                            <input id="id{{$key }}" name="slide_switch" type="radio" value="{{$image->image_url}}" /> <label for="id2"> <img src="{{$image->image_url}}" width="100" /> </label>
                                            <div class="img-details"><img src="{{$image->image_url}}" /></div>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
