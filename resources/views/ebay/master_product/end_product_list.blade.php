                ...
                <div class="screen-option">
                    <div class="d-flex justify-content-start align-items-center">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">End product</li>
                        </ol>
                    </div>
                                    ...
                                    <div class="ebay-master-product-search-form">
                                        <form class="d-flex" action="Javascript:void(0);" method="post">
                                            <div class="p-text-area">
                                                <input style="display:none;" type="text" name="search_value" id="search_value" class="form-control" placeholder="Search on eBay...." required>
                                            </div>
                                            <div class="submit-btn">
                                                <button style="display:none;" class="search-btn waves-effect waves-light" type="submit" onclick="catalogue_search();">Search</button>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="pagination-area">
                                        <form action="{{url('pagination-not-all')}}" method="get">
                                            ...
                                            <div class="datatable-pages d-flex align-items-center">
                                                <span class="displaying-num">  {{$onlySoftDeletedList->total()}} items</span>
                                                <span class="pagination-links d-flex">
                                                    @if($onlySoftDeletedList->currentPage() > 1)
                                                    <a class="first-page btn {{ $onlySoftDeletedList->currentPage() > 1 ? '' : 'disabled' }}" href="{{$end_decode_product_list->first_page_url}}" data-toggle="tooltip" data-placement="top" title="First Page">
                                                        <span class="screen-reader-text d-none">First page</span>
                                                        <span aria-hidden="true">«</span>
                                                    </a>
                                                    <a class="prev-page btn {{ $onlySoftDeletedList->currentPage() > 1 ? '' : 'disabled' }}" href="{{$end_decode_product_list->prev_page_url}}" data-toggle="tooltip" data-placement="top" title="Previous Page">
                                                    ...
                                                    <span class="paging-input d-flex align-items-center">
                                                        ...
                                                        <input class="current-page" id="current-page-selector" type="text" name="paged" value="{{$end_decode_product_list->current_page}}" size="3" aria-describedby="table-paging">
                                                        <span class="datatable-paging-text d-flex">of<span class="total-pages">{{$end_decode_product_list->last_page}}</span></span>
                                                        <input type="hidden" name="first_page_url" value="{{$end_decode_product_list->first_page_url}}">
                                                        <input type="hidden" name="route_name" value="ebay-end-product-list">
                                                        <input type="hidden" name="current_page" value="{{$onlySoftDeletedList->currentPage()}}">
                                                    </span>
                                                    @if($onlySoftDeletedList->currentPage() !== $onlySoftDeletedList->lastPage())
                                                    <a class="next-page btn" href="{{$end_decode_product_list->next_page_url}}" data-toggle="tooltip" data-placement="top" title="Next Page">
                                                        <span class="screen-reader-text d-none">Next page</span>
                                                        <span aria-hidden="true">›</span>
                                                    </a>
                                                    <a class="last-page btn" href="{{$end_decode_product_list->last_page_url}}" data-toggle="tooltip" data-placement="top" title="Last Page">
...
{{--                                                <option value="2">Check Status</option>--}}
                                                ...
                                                <option value="4">Permanent Delete</option>
                                            </select>
                                        </div>
                                        <div class="product-inner"><button type="button" class="btn btn-default" style="cursor: pointer"  target="_blank" data-toggle="tooltip" data-placement="top" title="Send">Send</button></div></th>
                                    <th class="image" style="width: 6% !important;">Image</th>
                                    <th class="item_id" style="width: 8%">
                                        <div class="d-flex justify-content-start">
                                            <div class="btn-group">
                                                <form action="{{url('eBay/end/product/search')}}" method="get">
                                                    @csrf
...
{{--                                                </form>--}}
                                    ...
                                    <th class="master_product_id text-center" style="width: 8%;">
...
{{--                                                    @csrf--}}
                                                    ...
                                                    <div class="dropdown-menu filter-content shadow" role="menu">
                                                        ...
                                                        <div class="checkbox checkbox-custom checkbox m-t-10 m-b-10">
                                                            <input id="opt-out6" type="checkbox" name="search_value[modifier_id][opt_out]" value="1" @isset($search_value['modifier_id']['opt_out']) checked @endisset><label for="opt-out6" >Opt Out</label>
                                                        </div>
{{--                                                        <input type="hidden" name="column_name" value="modifier_id">--}}
                                ...
                                @isset($search_value)
                                    @if(count($onlySoftDeletedList) == 0 && count($search_value) != 0)
                                    ...
                                    @endif
                                @endisset
                                @foreach($onlySoftDeletedList as $index => $product_list)
                                    ...
                                    <tr class="variation_load_tr">
                                        ...
                                        <td class="image" style="cursor: pointer; width: 6% !important;" data-toggle="collapse" id="mtr-{{$product_list->id}}" onclick="getVariation(this)" data-target="#demo{{$product_list->id}}" class="accordion-toggle">
                                            ...
                                            @if(isset( \Opis\Closure\unserialize($product_list->master_images)[0]))
                                                <a href=""  title="Click to expand" target="_blank"><img src="{{\Opis\Closure\unserialize($product_list->master_images)[0]}}" class="ebay-image zoom" alt="ebay-master-image"></a>
                                            @else
                                                <img src="{{asset('assets/common-assets/no_image.jpg')}}" class="ebay-image zoom" alt="ebay-master-image">
                                            @endif

                                        </td>
{{--                                        <td class="item-id" style="text-align: center !important; width: 10%" data-toggle="collapse" id="mtr-{{$product_list->id}}" onclick="getVariation(this)" data-target="#demo{{$product_list->id}}" class="accordion-toggle">--}}
...
{{--                                        <td class="catalogue-id" style="width: 10%; text-align: center !important;" data-toggle="collapse" id="mtr-{{$product_list->id}}" onclick="getVariation(this)" data-target="#demo{{$product_list->id}}" class="accordion-toggle">--}}
                                       ...
                                       <td class="stock" style="cursor: pointer; text-align: center !important; width: 5%" data-toggle="collapse" data-target="#demo{{$product_list->id}}" id="mtr-{{$product_list->id}}" onclick="getVariation(this)" class="accordion-toggle">{{$total_quantity}}</td>
                                        ...
                                        <td class="creator" style="cursor: pointer; text-align: center !important; width: 8%" data-toggle="collapse" id="mtr-{{$product_list->id}}" onclick="getVariation(this)" data-target="#demo{{$product_list->id}}" class="accordion-toggle">
                                            <div class="wms-name-creator">
                                                <div data-tip="on {{date('d-m-Y', strtotime($product_list->created_at))}}">
                                                    <strong class="text-success">{{\App\User::find($product_list->creator_id)->name ?? ''}}</strong>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="modifier" style="cursor: pointer; text-align: center !important; width: 8%" data-toggle="collapse" id="mtr-{{$product_list->id}}" onclick="getVariation(this)" data-target="#demo{{$product_list->id}}" class="accordion-toggle">
                                            @if(isset($product_list->modifier_info->name))
                                                <div class="wms-name-modifier1">
                                                    <div data-tip="on {{date('d-m-Y', strtotime($product_list->updated_at))}}">
                                                        <strong class="text-success">{{\App\User::find($product_list->modifier_id)->name ?? ''}}</strong>
                                                    </div>
                                                </div>
                                            @else
...
{{--                                                                <div class="align-items-center mr-2"><form action="{{url('relist-end-listing')}}" method="POST" >@csrf <input type="hidden" name="products[]" value="{{$product_list->id}}"> <button type="submit" class="btn-size btn-dark check-status-btn" style="cursor: pointer" target="_blank" data-toggle="tooltip" data-placement="top" title="Relist"><i class="fa fa-registered" aria-hidden="true"></i></button> </form></div>--}}
{{--                                                                @endif--}}
                                                            ...
                                                            <div class="align-items-center mr-2"><a class="btn-size edit-btn" style="cursor: pointer" href="{{url('create-ebay-product/'.$product_list->master_product_id.'/'.$product_list->profile_id.'/'.$product_list->item_id)}}" target="_blank" data-toggle="tooltip" data-placement="top" title="Edit & Relist"><i class="fa fa-edit" aria-hidden="true"></i></a></div>
...
{{--                                                            <div class="align-items-center mr-2"><form action="{{url('ebay-ended-product-check')}}" method="POST" >@csrf <input type="hidden" name="products[]" value="{{$product_list->id}}"> <button type="submit" class="btn-size btn-dark check-status-btn" style="cursor: pointer" target="_blank" data-toggle="tooltip" data-placement="top" title="Check Status"><i class="fa fa-hourglass-end" aria-hidden="true"></i></button> </form></div>--}}
                                                            <div class="align-items-center"><form action="{{url('permanent-delete')}}" method="POST" >@csrf <input type="hidden" name="products[]" value="{{$product_list->id}}"> <button type="submit" class="del-pub delete-btn" style="cursor: pointer" target="_blank" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button> </form></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--End dropup content-->
                            ...
                            <div class="row table-foo-sec">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-md-end align-items-center py-2">
                                        <div class="pagination-area">
                                            <div class="datatable-pages d-flex align-items-center">
                                                <span class="displaying-num pr-1"> {{$onlySoftDeletedList->total()}} items </span>
                                                <span class="pagination-links d-flex">
                                                    @if($onlySoftDeletedList->currentPage() > 1)
                                                    <a class="first-page btn {{ $onlySoftDeletedList->currentPage() > 1 ? '' : 'disabled' }}" href="{{$end_decode_product_list->first_page_url}}" data-toggle="tooltip" data-placement="top" title="First Page">
                                                        <span class="screen-reader-text d-none">First page</span>
                                                    ...
                                                    <span class="paging-input d-flex align-items-center">
                                                        <span class="datatable-paging-text  d-flex pl-1"> {{$end_decode_product_list->current_page}} of <span class="total-pages">{{$end_decode_product_list->last_page}}</span></span>
                                                    </span>
                                                    @php
                                                        ...
                                                        $page =  $onlySoftDeletedList->currentPage()+1;

                                                    @endphp
                                                    @if($onlySoftDeletedList->currentPage() !== $onlySoftDeletedList->lastPage())
{{--                                                        <form action="{{$onlySoftDeletedList->appends(request()->query())}}" class="next-page btn"  method="GET">--}}
