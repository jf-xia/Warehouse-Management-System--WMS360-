                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box screen-option-content p-t-20 p-b-30" style="display: none; padding-top: 25px; padding-bottom: 25px;">
                            <h4 class="text-center"><i class="fas fa-sync font-18" aria-hidden="true"></i> Sync Orders Manually</h4><br>
                            <!--Order by channel sync area-->
                            <div class="order-sync-area m-b-20 justify-content-center">
                                @if (Session::get('woocommerce') == 1)
                                <div>
                                    <a href="{{url('sync-order-from-woocommerce-clicked')}}" class="syncronize">
                                        <!-- <img src="{{asset('assets/images/woocommerce-logo.png')}}" alt="WOOCOMMERCE"> -->
                                        <i class="fab fa-wordpress ml-1 custom-font"  title="Woocommerce"></i>
                                        <!-- <i class="fas fa-sync ml-2 font-18" aria-hidden="true"></i> -->
                                    </a>
                                </div>
                                @endif
                                @if (Session::get('amazon') == 1)
                                <div class="ml-2 amazon-sync">
                                    <a href="Javascript::void" class="syncronize amazon-order-syncronize" title="Sync Order From Amazon">
                                        <!-- <img src="{{asset('assets/common-assets/amazon-logo.png')}}" alt="Amazon"> -->
                                        <i class="fab fa-amazon custom-font" title="Amazon"></i>
                                        <!-- <i class="fas fa-sync ml-2 font-18" aria-hidden="true"></i> -->
                                    </a>
                                </div>
                                @endif
                                @if (Session::get('shopify') == 1)
                                <div class="ml-2 shopify-sync">
                                    <a href="{{url('shopify/order-details')}}" class="syncronize">
                                        <!-- <img style="width: 50px;" src="{{asset('assets/common-assets/shopify.png')}}" alt="Shopify"> -->
                                        <i class="fab fa-shopify custom-font" title="Shopify"></i>
                                        <!-- <i class="fas fa-sync ml-2 font-18" aria-hidden="true"></i> -->
                                    </a>
                                </div>
                                @endif
                                ...
                                <div class="ml-2">
                                    <a href="{{url('onbuy/sync-order-from-onbuy-clicked')}}" class="syncronize">
                                        <!-- <img src="{{asset('assets/images/onbuy-logo.png')}}" alt="ONBUY"> -->
                                        <i class="fas fa-shopping-cart custom-font" title="OnBuy"></i>
                                        <!-- <i class="fas fa-sync ml-2 font-18" aria-hidden="true"></i> -->
                                    </a>
                                </div>
                                @endif
                                @if (Session::get('ebay') == 1)
                                <div class="ml-2 ebay-sync">

                                    <form action="{{URL::to('sync-order-from-ebay-clicked/form')}}" method="GET">
                                        <div class="row ebay-sync">
                                            <div>
                                                <button class="syncronize" type="submit" style="margin-left: 12%;">
                                                    <i class="fab fa-ebay custom-font" title="eBay"></i>
                                                </button>
                                            </div>

                                            <div class="float-left">
                                                <input type="date" class="custom-date" name="date" value="{{\Carbon\Carbon::now()->format('Y-m-d')}}">
                                            </div>
                                        </div>
                                    ...
                                    {{--                                    <a href="{{url('sync-order-from-ebay-clicked')}}" class="syncronize">--}}
                                    {{--                                        <!-- <img src="{{asset('assets/common-assets/ebay-42x16.png')}}" alt="EBAY"> -->--}}
                                    {{--                                        <i class="fab fa-ebay custom-font" title="eBay"></i>--}}
                                    {{--                                        <!-- <i class="fas fa-sync ml-2 font-18" aria-hidden="true"></i> -->--}}
                                    {{--                                    </a>--}}
                                </div>
...
{{--                                <div class="ml-2 shopify-sync">--}}
{{--                                    <a href="{{url('shopify/order-details')}}" class="syncronize">--}}
{{--                                        <img style="width: 50px;" src="{{asset('assets/common-assets/shopify.png')}}" alt="Shopify"><i class="fa fa-refresh font-18 ml-1" aria-hidden="true"></i>--}}
{{--                                    </a>--}}
{{--                                </div>--}}
                            </div>
                            ...
                            <div class="row content-inner screen-option-responsive-content-inner">
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                                            <input type="checkbox" name="order_note" class="onoffswitch-checkbox" id="order_note" tabindex="0" @if(isset($setting['order']['order_awaiting_dispatch']['order_note']) && $setting['order']['order_awaiting_dispatch']['order_note'] == 1) checked @elseif(isset($setting['order']['order_awaiting_dispatch']['order_note']) && $setting['order']['order_awaiting_dispatch']['order_note'] == 0) @else checked @endif>
                                            <label class="onoffswitch-label" for="order_note">
                                                <span class="onoffswitch-inner"></span>
                                                <span class="onoffswitch-switch"></span>
                                            </label>
                                        </div>
                                        <div class="ml-1"><p>Order Note</p></div>
                                    </div>
                                    <div class="d-flex align-items-center mt-2">
                                        <div class="onoffswitch">
                ...
                <div class="screen-option">
                    <div class="d-flex justify-content-start align-items-center">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Awaiting Dispatch</li>
                        </ol>
                    </div>
...
{{--                                            </button>--}}
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary add-note" data-dismiss="modal">Add</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <!--End Order Note Modal-->
                                ...
                                <div class="product-inner dispatched-order">
                                    ...
                                    <div class="dispatched-search-area">
                                        <div data-tip="Search by OrderNo, CustomerName, City, PostCode, ProductName, Sku">
                                            ...
                                            <input type="hidden" name="order_search_status" id="order_search_status" value="processing">
                                        </div>
                                    </div>
                                            ...
                                            <div class="datatable-pages d-flex align-items-center">
                                                ...
                                                <span class="pagination-links d-flex">
                                                    ...
                                                    <span class="paging-input d-flex align-items-center">
                                                        ...
                                                        <input type="hidden" name="route_name" value="order/list">
                                                    </span>
                               ...
                               <!--End awaiting dispatch select picker content-->
                                ...
                                <!--start table section-->
                                <table class="order-table receive-order w-100" style="border-collapse:collapse;" id="orderTable">
                                    <thead>
                                        <form action="{{url('all-column-search')}}" method="post">
                                            @csrf
                                            <input type="hidden" name="search_route" value="order/list">
                                            ...
                                            <tr>
                                                ...
                                                <th class="status" style="width: 10%; text-align: center !important;">Status</th>
                                                <th class="order_note" style="width: 20%">
                                                    <div class="d-flex justify-content-center">
                                                        <div class="btn-group">
                                                            <a type="button" class="dropdown-toggle filter-btn " data-toggle="dropdown">
                                                                <i class="fa  @isset($allCondition['order_note'])text-warning @endisset" aria-hidden="true"></i>
                                                            </a>
                                                            <div class="dropdown-menu filter-content shadow" role="menu">
                                                                <p>Filter Value</p>
                                                                <select class="form-control b-r-0" name="order_note">
                                                                    <option value="">Select Order Note</option>
                                                                    <option value="1" @if(isset($allCondition['order_note']) && ($allCondition['order_note'] == 1)) selected @endif>With Order Note</option>
                                                                    <option value="0" @if(isset($allCondition['order_note']) && ($allCondition['order_note'] == 0)) selected @endif>Without Order Note</option>
                                                                </select>
                                                                @if(isset($allCondition['order_note']))
                                                                    <div class="individual_clr">
                                                                        <button title="Clear filters" type="submit" name="order_note" value=" " class='btn btn-outline-info clear-params'><i class="fas fa-times"></i></button>
                                                                    </div>
                                                                @endif
                                                                <button type="submit" class="btn btn-primary filter-apply-btn float-right">Apply <i class="fa fa-arrow-circle-right ml-1"></i></button>
                                                            </div>
                                        ...
                                        <?php // dd($all_pending_order); exit(); ?>
                                            <tr class="order_number_{{$pending->order_number}} shipping_fee_order_no_check">
                                                <td class="checkboxShowHide{{$pending->id}}" style="width: 4%; text-align: center !important;">
                                                    ...
                                                    @else
                                                        <input type="checkbox" style="display: none" class="" id="customCheck{{$pending->id}}" value="{{$pending->id}}">
                                                    @endif
                                                </td>
                                                ...
                                                @elseif($pending->status == 'completed')
                                                    <td class="status" style="cursor: pointer; text-align: center !important; width: 10%" data-toggle="collapse" data-target="#demo{{$pending->order_number}}" class="accordion-toggle">
...
{{--                    <input type="radio" name="cancel_reason" value="Defect">Defect--}}
  ...
  <script>
              ...
              $.ajax({
                  ...
                  success: function (response) {
                    if(response.data !== 'error'){
                        ...
                        $("#customCheck"+response.data.order_id).hide();
                        $("#s"+response.data.order_id).show()
                    }else{
                        $('.modal-body p').show();
              ...
              $.ajax({
                  ...
                  success: function (response) {
                      ...
                      if(response.data !== 'error'){
                          ...
                          $('textarea#order_note').val('');
                          $("#s"+order_id).hide()
                          $('table tr td button.append_button'+order_id).show();
                      }else{
                          $('#orderNoteModalView .modal-body-view p').show();
                          $('#orderNoteModalView .modal-body-view p').html('Something went wrong').addClass('text-danger').fadeOut(10000);
                          // console.log(id)
      ...
      function deleteOrderProduct(orderId, productId = null){
        ...
        $("tbody").on( "click",'.checkBoxClass', countCheckedAll );
