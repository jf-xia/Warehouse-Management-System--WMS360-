                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="vendor-title">
                            <p>{{$vendor_name}}'s Product List</p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        ...
                                        <table id="tech-companies-1" class="table table-bordered  table-striped" style="border-collapse:collapse;">
                                            ...
                                            <tr>
                                                ...
                                                <th data-priority="2">Invoice Total Price</th>
                                                <th data-priority="3">Invoice Receive By</th>
                                                <th data-priority="4">Receive Data</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            @foreach($all_variation_product as $variation_product)
