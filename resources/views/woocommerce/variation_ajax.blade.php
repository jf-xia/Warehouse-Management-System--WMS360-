...
{{--                        <th class="image" style="text-align: center !important; width: 6%;">Image</th>--}}
                        ...
                        <th class="ean" style="width: 10% !important;">EAN</th>
                    ...
                    <tbody>
                    @isset($list->woocommVariation)
                        @foreach($list->woocommVariation as $product_variation)
                            @php
...
{{--                                            <img class="thumb-md" src="{{$product_variation->image}}" height="60" width="60" alt="WooCommerce image">--}}
{{--                                        </a>--}}
{{--                                    </td>--}}
{{--                                @elseif(isset($product_draft_variation_results->all_image_info[0]->image_url))--}}
{{--                                    <td class="image" style="text-align: center !important; width: 6%;">--}}
{{--                                        <img class="thumb-md" src="{{$product_draft_variation_results->all_image_info[0]->image_url}}" height="60" width="60" alt="WooCommerce image">--}}
{{--                                    </td>--}}
{{--                                @else--}}
{{--                                    <td class="image" style="text-align: center !important; width: 6%;">--}}
{{--                                        <img class="thumb-md" src="{{asset('assets/images/users/no_image.jpg')}}" height="60" width="60" alt="WooCommerce image">--}}
{{--                                    </td>--}}
{{--                                @endif--}}
                                ...
                                <td class="ean" style="width: 10% !important;">{{$product_variation->ean_no}}</td>
                                <td class="regular-price" style="width: 10% !important; text-align: center !important;">{{$product_variation->regular_price}}</td>
                                <td class="sales-price" style="width: 10% !important; text-align: center !important;">{{$product_variation->sale_price}}</td>
                                <td class="sold" style="width: 5% !important; text-align: center !important;">{{$total_sold ?? 0}}</td>
                                <td class="available-qty" style="width: 10% !important; text-align: center !important;">{{$product_variation->actual_quantity}}</td>
                                ...
                                @if($shelfUse == 1)
                                    ...
                                    @endif
                                @endif
                                <td class="actions dropup" style="width: 6%">
                                                ...
                                                <div class="action-1">
                                                    ...
                                                    <div class="align-items-center">
                                                        <form action="{{url('woocommerce/variation/delete/'.$product_variation->id)}}" method="post">
                                                            @csrf
                                                            <button class="btn-size del-pub delete-btn" style="cursor: pointer" href="#" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return check_delete('product');"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="row-expand-height-control">
                    <table class="product-draft-table row-expand-table w-100">
                        ...
                        <tr>
                            ...
                            <th class="variation" style="width: 10%">Variation</th>
                            <th class="ean" style="text-align: center !important;">EAN</th>
                            <th class="regular-price" style="width: 15% !important; text-align: center !important;">Regular Price</th>
                            <th class="sales-price" style="width: 15% !important; text-align: center !important;">Sales Price</th>
                            <th class="sold" style="width: 5% !important; text-align: center !important;">Sold</th>
                            <th class="available-qty" style="width: 15% !important; text-align: center !important;">Available Qty</th>
                            @if($shelfUse == 1)
                                <th class="shelf-qty" style="width: 15% !important; text-align: center !important;">Shelf Qty</th>
                            @endif
                            <th style="width: 6%">Actions</th>
                        </tr>
                        </thead>
                        <tbody>
                        @if(count($product_draft) > 0)
                            @foreach($product_draft as $product_variation)
                                ...
                                <tr>
                                    ...
                                    <td class="sku" style="width: 10%">
                                        <div class="sku_tooltip_container d-flex justify-content-start" style="">
                                            <div title="Click to Copy" onclick="wmsSkuCopied(this);" class="sku_copy_button">{{$product_variation->sku}}</div>
                                            <span class="wms__sku__tooltip__message" id="wms__sku__tooltip__message">Copied!</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="ean" style="text-align: center !important;">{{$product_variation->ean_no}}</td>
                                    <td class="regular-price" style="width: 15% !important; text-align: center !important;">
                                        <div class="d-flex justify-content-center align-items-center">
                                                                                    <span class="shown" id="regular_price_{{$product_variation->id}}">{{$product_variation->regular_price}}
                                    ...
                                    <td class="sales-price" style="width: 15% !important; text-align: center !important;">
                                        <div class="d-flex justify-content-center align-items-center">
                                                                                    <span class="shown" id="sale_price_{{$product_variation->id}}">{{$product_variation->sale_price}}
                                                                                         <div class="hover-shown">
                                                                                             <form action="Javascript:void(0);">
                                    ...
                                    <td class="sold" style="width: 5% !important; text-align: center !important;">{{$total_sold ?? 0}}</td>
                                    <td class="available-qty" style="width: 15% !important; text-align: center !important;">
                                        <div class="d-flex justify-content-center align-items-center">
                                                                                    <span class="shown" id="actual_quantity_{{$product_variation->id}}">{{$product_variation->actual_quantity}}
                                                                                         <div class="hover-shown">
                                                                                             <form action="Javascript:void(0);">
                                    ...
                                    @if($shelfUse == 1)
                                        @if($product_variation->notification_status == 1 && $data < $product_variation->low_quantity)
                                            <td class="shelf-qty" style="width: 15% !important; text-align: center !important;">{{$data}}<br><span class="label label-table label-danger">Low Quantity {{$product_variation->low_quantity}}</span></td>
                                        @else
                                            <td class="shelf-qty" style="width: 15% !important; text-align: center !important;">{{$data}}</td>
                                        @endif
                                    @endif
                                    <td class="actions" style="width: 6%">
                                        ...
                                        <div class="btn-group dropup">
                                            ...
                                            <!--start dropup content-->
                                            <div class="dropdown-menu woocommerce-pending-product">
                                                <div class="dropup-content catalogue-dropup-content">
                                                    <div class="action-1">
