                ...
                <div class="row m-t-20">
                    <div class="col-md-12">
                        <div class="card-box shadow">
                            ...
                            <form role="form" class="vendor-form mobile-responsive" action="{{url('role/'.$single_role->id)}}" method="post">
                                @method('PUT')
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="role_name" class="form-control" id="role_name" value="{{ $single_role->role_name ? $single_role->role_name : old('role_name') }}" placeholder="Enter role name" required>
                                    </div>
                                    <div class="col-md-1"></div>
                                </div>
